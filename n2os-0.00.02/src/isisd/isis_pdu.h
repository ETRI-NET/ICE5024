 ...
 */
extern void isisReceive (Int32T fd, Int16T event, void *args);
 ...
 * Sending functions
 */
extern int send_csnp (struct isis_circuit *circuit, int level);
extern void sendLanL1Hello (Int32T fd, Int16T event, void * arg);
extern void sendLanL2Hello (Int32T fd, Int16T event, void * arg);
extern void sendP2pHello (Int32T fd, Int16T event, void * arg);
extern void sendL1Csnp (Int32T fd, Int16T event, void * arg);
extern void sendL2Csnp (Int32T fd, Int16T event, void * arg);
extern void sendL1Psnp (Int32T fd, Int16T event, void * arg);
extern void sendL2Psnp (Int32T fd, Int16T event, void * arg);

extern void sendLsp (Int32T fd, Int16T event, void * arg);
extern int ack_lsp (struct isis_link_state_hdr *hdr,
	     struct isis_circuit *circuit, int level);
extern void fill_fixed_hdr (struct isis_fixed_hdr *hdr, u_char pdu_type);
extern int send_hello (struct isis_circuit *circuit, int level);
