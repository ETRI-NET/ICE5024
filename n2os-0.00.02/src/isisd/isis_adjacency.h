...
struct isis_adjacency
{
  ...
  void *pTimerExpire;       /* expire after hold_time  */
...
void isisAdjExpire (Int32T fd, Int16T event, void *args);
void isisAdjPrintCmsh (struct isis_adjacency *adj, struct cmsh *cmsh, char detail);
