...
extern dict_t *lsp_db_init (void);
extern void lsp_db_destroy (dict_t * lspdb);
extern void lspTick (Int32T fd, Int16T event, void * arg);

extern int lsp_generate (struct isis_area *area, int level);
extern int lsp_regenerate_schedule (struct isis_area *area, int level,
                             int all_pseudo);
extern int lsp_generate_pseudo (struct isis_circuit *circuit, int level);
extern int lsp_regenerate_schedule_pseudo (struct isis_circuit *circuit, int level);

extern struct isis_lsp *lsp_new (u_char * lsp_id, u_int16_t rem_lifetime,
			  u_int32_t seq_num, u_int8_t lsp_bits,
			  u_int16_t checksum, int level);
extern struct isis_lsp *lsp_new_from_stream_ptr (struct stream *stream,
					  u_int16_t pdu_len,
					  struct isis_lsp *lsp0,
					  struct isis_area *area,
                                          int level);
extern void lsp_insert (struct isis_lsp *lsp, dict_t * lspdb);
extern struct isis_lsp *lsp_search (u_char * id, dict_t * lspdb);

extern void lsp_build_list (u_char * start_id, u_char * stop_id, u_char num_lsps,
...
void lspPrint (struct isis_lsp *lsp, struct cmsh *cmsh, char dynhost);
void lspPrintDetail (struct isis_lsp *lsp, struct cmsh *cmsh, char dynhost);
Int32T lspPrintAll (struct cmsh *cmsh, dict_t * lspdb, char detail, char dynhost);
const char *lsp_bits2string (u_char *);

/* sets SRMflags for all active circuits of an lsp */
void lsp_set_all_srmflags (struct isis_lsp *lsp);

extern void lspL1Refresh (Int32T fd, Int16T event, void *args);
extern void lspL2Refresh (Int32T fd, Int16T event, void *args);
extern void lspL1RefreshPseudo (Int32T fd, Int16T event, void *args);
extern void lspL2RefreshPseudo (Int32T fd, Int16T event, void *args);
