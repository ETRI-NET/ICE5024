...
{
  PREFIX_TYPE_STRING_ORG,
  PREFIX_TYPE_NUMBER_ORG
};
...
extern struct prefix_list *prefix_list_lookup (afi_t_org, const char *);
extern enum prefix_list_type prefix_list_apply (struct prefix_list *, void *);

extern struct stream * prefix_bgp_orf_entry (struct stream *,
                                             struct prefix_list *,
                                             u_char, u_char, u_char);
extern int prefix_bgp_orf_set (char *, afi_t_org, struct orf_prefix *, int, int);
extern void prefix_bgp_orf_remove_all (char *);
extern int prefix_bgp_show_prefix_list (struct vty *, afi_t_org, char *);
