...
typedef enum
{
  RMAP_EVENT_SET_ADDED_ORG,
  RMAP_EVENT_SET_DELETED_ORG,
  RMAP_EVENT_SET_REPLACED_ORG,
  RMAP_EVENT_MATCH_ADDED_ORG,
  RMAP_EVENT_MATCH_DELETED_ORG,
  RMAP_EVENT_MATCH_REPLACED_ORG,
  RMAP_EVENT_INDEX_ADDED_ORG,
  RMAP_EVENT_INDEX_DELETED_ORG
} route_map_event_t;
...
enum
{
  ...
  RMAP_RULE_MISSING_ORG = 1,

  /* Route map rule can't compile */
  RMAP_COMPILE_ERROR_ORG
};
...
extern struct route_map_index * route_map_index_get (struct route_map *map, enum route_map_type type,
		     int pref);
