...
#define DEFAULT_ROUTE		    RIB_ROUTE_TYPE_MAX
...
extern int ospf_distance_set (struct cmsh *, struct ospf *, const char *,
			      const char *, const char *);
extern int ospf_distance_unset (struct cmsh *, struct ospf *, const char *,
				const char *, const char *);
extern void ospf_zebra_init (void);

extern void ospf_filter_update (AccessListT *);
extern void ospf_prefix_list_update (PrefixListT *);

extern void ospfDistributeListUpdateTimer (Int32T , Int16T , void * );
