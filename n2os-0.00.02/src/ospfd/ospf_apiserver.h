...
struct ospf_apiserver
{
  ...
  void *pSockFdSyncReadEvent;
#ifdef USE_ASYNC_READ
  void *pSockFdAsyncReadEvent;
#endif /* USE_ASYNC_READ */
  void *pSockFdSyncWriteEvent;
  void *pSockFdAsyncWriteEvent;
};
...
extern void ospfApiserverAccept (Int32T fd, Int16T event, void *args);
extern void ospfApiserverRead (Int32T fd, Int16T event, void *args);
extern void ospfApiserverSyncWrite (Int32T fd, Int16T event, void *args);
extern void ospfApiserverAsyncWrite (Int32T fd, Int16T event, void *args);
...
extern void ospf_apiserver_show_info (struct cmsh *cmsh, struct ospf_lsa *lsa);
